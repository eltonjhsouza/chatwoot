class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'captain' => %w[CAPTAIN_OPEN_AI_API_KEY CAPTAIN_OPEN_AI_MODEL CAPTAIN_FIRECRAWL_API_KEY],
      'custom_branding' => %w[INSTALLATION_NAME LOGO_THUMBNAIL LOGO LOGO_DARK BRAND_URL WIDGET_BRAND_URL BRAND_NAME TERMS_URL PRIVACY_URL DISPLAY_MANIFEST]
    }
